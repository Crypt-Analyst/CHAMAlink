...
AFRICAN_COUNTRIES = [
    ...
    {'code': 'KE', 'name': 'Kenya', 'currency': 'KES'},  # Primary market
    ...
    {'code': 'TZ', 'name': 'Tanzania', 'currency': 'TZS'},  # Key market
    {'code': 'TG', 'name': 'Togo', 'currency': 'XOF'},
    {'code': 'TN', 'name': 'Tunisia', 'currency': 'TND'},
    {'code': 'UG', 'name': 'Uganda', 'currency': 'UGX'},  # Key market
...
ALL_COUNTRIES = AFRICAN_COUNTRIES + GLOBAL_COUNTRIES
